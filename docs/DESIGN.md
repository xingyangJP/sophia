...
| 版 | **2.1** |
| 作成日 | 2026-08-15 |
| 更新日 | 2026-08-17（**A1 の実装が入ったので、設計案だったコード片と構成を実装に合わせた。** 第3・4・5・6・7・9・11・12・13章を書き換え、4.8節（自己認識）を新設。第2章の実測値は変更なし。**同日さらに、2.6節に MLX の実測とプリフィル崩れを、第14章にパーソナライズの初期化（FR-24〜29）を追加**） |
...
自己認識のたった3行ですら**概算 +71トークン/ターン**である（4.8節）。
